...
const sortNames = (arr) => {
  // Solution code here...
  arr.sort();
  // by default, sort() sorts the elements in alphabetical order, treating uppercase letters as smaller than lowercase letters. Capital letters come before lowercase letters.
  return arr;
};
